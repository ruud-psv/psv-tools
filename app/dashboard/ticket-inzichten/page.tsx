  ...
  return (
    <div className="p-8">
      ...
      <p className="text-muted-foreground mb-6">
        Real-time beschikbaarheid van tickets voor wedstrijden, tours, museum en andere evenementen. Vernieuwt automatisch elke 30 seconden. Beschikbaarheidsverloop wordt per uur opgeslagen.
      </p>
